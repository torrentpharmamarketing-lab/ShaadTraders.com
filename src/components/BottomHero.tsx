      ...
      <div className="max-w-7xl mx-auto">
        <div className="relative w-full aspect-[16/9] md:aspect-[21/9] overflow-hidden">
          ...
          <div className="absolute bottom-6 left-1/2 -translate-x-1/2 md:translate-x-0 md:left-auto md:right-12 md:bottom-12 flex justify-center z-50">
            <Button onClick={handleWhatsAppOrder} size="lg" className="bg-[#25D366] text-white hover:bg-[#20bd5a] rounded-full uppercase tracking-widest font-semibold flex items-center gap-2 shadow-xl w-[90%] sm:w-auto">
